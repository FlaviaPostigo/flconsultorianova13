      ...
      <section className="relative overflow-hidden texture-paper">
        ...
        <div className="container-fl relative grid gap-12 py-20 md:py-28 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="relative flex items-center justify-center lg:col-span-5">
            <div
              className="relative aspect-square w-full max-w-[470px]"
              aria-label="Elemento gráfico com o símbolo da FL Consultoria"
            >
              <svg
                aria-hidden
                viewBox="0 0 500 500"
              ...
              >
                ...
                <circle
                  ...
                  r="156"
                  fill="none"
                  stroke="rgb(118 199 146 / .22)"
                  strokeWidth="2"
                />
                <path
                  d="M72 283 A184 184 0 0 1 292 68"
                  fill="none"
                  stroke="#58B978"
                  strokeWidth="20"
                  strokeLinecap="round"
                />
                <circle cx="381" cy="112" r="13" fill="#76C792" />
                <circle cx="425" cy="176" r="8" fill="#58B978" />
                <circle cx="102" cy="394" r="8" fill="#58B978" />
              </svg>

              <div className="absolute inset-[23%] grid place-items-center rounded-[2.1rem] border border-mint-deep/35 bg-cream/95 p-8 shadow-[0_18px_45px_rgba(38,36,91,0.16)] backdrop-blur-sm">
                <img
                  src={logoMark}
